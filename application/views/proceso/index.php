                                        ...
                                        <table   class="table table-striped responsive-utilities jambo_table bulk_action"  >
                                            ...
                                            <tbody>
                                                <tr v-for="row in procesos" >
                                                    ...
                                                    <td align="right">
                                                        <button type="button" class="btn btn-success" @click="editModal = true; selectProceso(row)" title="Modificar Datos">
                                                            <i class="fa  fa-edit"></i> Modificar
                                                        </button>
                                                        <a v-bind:href="'ver/'+ row.idproceso" class="btn btn-info" title="Agregar revisión">
