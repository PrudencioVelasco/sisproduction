        ...
        <div class="modal-content">
            ...
            <form method="post" action="" id="frmactualizarentrada">
               ...
               <div class="modal-footer">
                ...
                <button type="button" id="btnupdateentrada" class="btn btn-primary">Aceptar</button>
            </div>
        </form>
    </div>
</div>
            ...
            <form method="post" action="" id="frmactualizarsalida">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control idlaminasalida" type="hidden" name="idlamina">
                        <input class="form-control idmaquinasalida" type="hidden" name="idmaquina">
                    </div>
                    <div class="form-group">
