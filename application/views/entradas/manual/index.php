    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3><strong>ADMINISTRAR MANUALES</strong></h3>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div id="app">
                                                              ...
                                                              <li><a href="#" style="color:green;" class="edit_button"
                                                                ...
                                                                <li><a href="#" style="color:blue;" class="edit_button_salida"
                                                                    ...
                                                                    <li><a href="#" style="color:red;" class="edit_button_devolucion"
                                                                        ...
                                                                        <li class="divider"></li>
                                                                        <li><a href="<?php echo site_url('Litho/detalle_manual/'.$value->idrevision) ?>"><i class="fa fa-exchange"></i> <strong>Movimientos</strong></a></li>
                                                                    </ul>
                                                                </div>
                                                                <?php
                                                                    }
...
<script>
    $("#btnentrada").click(function(){
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Litho/agregar_entrada_manual');?>",
    ...
    $("#btnsalida").click(function(){
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Litho/agregar_salida_manual');?>",
    ...
    $("#btndevolucion").click(function(){
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Litho/devolucion_manual');?>",
