                             ...
                             <br>
                              <table class="table is-bordered is-hoverable">
                                 <thead class="text-white bg-dark" >
                                    <th class="text-white">Nombre del turno</th>
                                    <th class="text-white">Hora inicial</th>
                                    <th class="text-white">Hora final</th>
 ...
 <script src="<?php echo base_url();?>/assets/js/appvue/appturno.js"></script> 