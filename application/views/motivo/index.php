    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><strong>Administrar Motivos de Rechazo</strong></h2>
                            ...
                            <div class="container">
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button class="btn btn-round btn-primary" @click="addModal= true"><i class='fa fa-plus'></i> Nuevo motivo</button>
                                       ...
                                       <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                            ...
                                            <tbody class="table-light">
                                                <tr v-for="row in motivos" class="table-default">
                                                    ...
                                                    <td align="right">
                                                        <button type="button" class="btn btn-icons btn-rounded btn-info btn-sm" @click="editModal = true; selectMotivo(row)" title="Modificar Datos">
