...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12"> 
                        <table id="datatablereportecalidad" class="table">
                            <thead>
                                <tr>
    ...
    <hr/>
    <form method="POST" action="<?= base_url('reporte/generar_pdf_calidad') ?>"> 
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#datatablereportecalidad').DataTable({
            "scrollX": false,
            dom: 'Bfrtip',
            buttons: [
            ],
