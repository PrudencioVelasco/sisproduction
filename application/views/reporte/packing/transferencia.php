            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                         <h3>REPORTE POR TRANSFERENCIA</h3>
                    </div>
                ...
                <div class="x_content">
 <small>Campos con <font color="red">*</font> son obligatorio. </small>
                    <form method="POST" action="<?= base_url('Reporte/buscar_reporte_packing_transferencia') ?>">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                              ...
                              <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label><font color="red">*</font> Transferencia inicial</label>
                                    <input type="number" name="tinicio" class="form-control" required="">
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label><font color="red">*</font> Transferencia final</label>
                                    <input type="number" name="tfinal" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='datetimepicker3' style="border-radius: 3px; border:solid 2px #ccc; ">
                                    <input type='text' class="form-control"  placeholder="Fecha inicio"  name="fechainicio" />
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='datetimepicker4' style="border-radius: 3px; border:solid 2px #ccc; ">
                                    <input type='text' class="form-control "  placeholder="Fecha fin" name="fechafin" />
                                    <span class="input-group-addon" style="border-radius: 2px; border:solid 1px #ccc; padding-bottom: 10px; padding-left: 10px;"  title="Clic para seleccionar la fecha.">
                                        <span style="color: blue;  font-size: 18px"  class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                ...
                <div class="row">
                    ...
                    <?php endif; ?>
                       <?php if (isset($informacion2) && !empty($informacion2)): ?>
                            <?php foreach ($informacion2 as $value2): ?>
                                <tr>
                                    <td><?php echo $value2->numeroparte; ?></td>
                                    <td><?php echo $value2->modelo; ?></td>
                                    <td><?php echo $value2->revision; ?></td>
                                    <td><?php echo "---"; ?></td>
                                    <td><?php echo "LINEA ".$value2->tiempo;?></td>
                                    <td><?php echo $value2->totalcajas; ?></td>
                                    <td><?php echo "---"; ?></td>
                                    <td><?php echo $value2->totalpallet; ?></td>
                                     <td>VESPERTINO</td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
    ...
    <hr/>
    <form method="POST" action="<?= base_url('Reporte/generar_pdf_packing_transferencia') ?>">
        <?php  if (!empty($tipo) && !empty($tinicio) && !empty($tfinal)) {?>
         ...
         <input type = "hidden" name="tinicio" value="<?php echo $tinicio; ?>"/>
         <input type = "hidden" name="tfinal" value="<?php echo $tfinal; ?>"/>
     <?php }?>
     <div class="row">
        <div class="col-md-1 col-sm-12 col-xs-12">
            <div class="form-group"  >
