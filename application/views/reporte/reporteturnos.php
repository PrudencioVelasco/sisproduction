...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="<?= base_url('reporte/buscar_reporte_proceso_turnos') ?>">     
                           ...
                           <tbody>
                            ...
                            <?php foreach ($informacion as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo $value->cantidad * $value->totalpallet; ?></td>
        ...
        <hr/>
        <form method="POST" action="<?= base_url('reporte/generar_pdf_turno') ?>"> 
                    ...
                    <!--<div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='datetimepicker5'>
                                <input type='text' class="form-control " name="fechaturno" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
