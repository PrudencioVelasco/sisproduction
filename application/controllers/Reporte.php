...
public function generar_pdf_turno(){
    ...
    <td><p style="font-size:9px;">'.number_format($value->cantidad * $value->totalpallet).'</p></td>
    <td><p style="font-size:9px;">'.number_format($value->cantidad).'</p></td>
