...
class Calidad_model extends CI_Model {
    ...
    {
        $this->db->select('d.iddetalleparte,d.folio,p.idparte,d.revision,c.idcliente, s.idestatus, p.numeroparte,c.nombre,u.name,uo.name as nombreoperador,d.fecharegistro,d.pallet,d.cantidad,s.nombrestatus');
