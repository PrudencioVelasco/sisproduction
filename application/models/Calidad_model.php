    ...
    public function buscar($text) {
       ...
       (SELECT Count(pc7.idestatus)
        ...
        WHERE  pc7.iddetalleparte = d.iddetalleparte
               AND pc7.idestatus = 1)                    AS totalenviadoacalidad
       ,
       ...
       (SELECT Count(pc5.idestatus)
        ...
        WHERE  pc5.iddetalleparte = d.iddetalleparte
               AND pc5.idestatus = 6)                    AS totalcancelado,
       (SELECT Count(pc6.idestatus)
        FROM   palletcajas pc6
        WHERE  pc6.iddetalleparte = d.iddetalleparte
               AND pc6.idestatus = 7)                    AS totalenviadoaalmacen
       ,
       (SELECT Count(pc8.idestatus)
        FROM   palletcajas pc8
        WHERE  pc8.iddetalleparte = d.iddetalleparte
               AND pc8.idestatus = 3)                    AS rechazadoapacking,
              ...
              OR d.iddetalleparte IN (SELECT pcv.iddetalleparte
                                      ...
                                      WHERE  pv.idparte = dpv.idparte
                                             AND dpv.iddetalleparte =
                                                 pcv.iddetalleparte
                                             AND CONCAT(pv.numeroparte,'_', pcv.idpalletcajas)   LIKE '%$text%')
           )
ORDER  BY d.fecharegistro DESC");
        //  return $query->result();
